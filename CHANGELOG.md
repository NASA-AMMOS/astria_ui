...
## [8.7.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/11.0.0) - 2025-06-16

### Updates

- Remove image and spectral shot co-registration capabilities

## [8.6.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/10.0.0) - 2025-03-10

### Bug Fixes

- Fix inconsistencies while opening images in ASTTRO ([MSGDS-8853](https://jira.jpl.nasa.gov/browse/MSGDS-8853))

## [8.5.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/9.0.0) - 2024-10-11
...
## [8.4.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/8.0.0) - 2024-08-13
...
- Fix issue loading certain layers from CAMP

## [8.3.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/7.0.0) - 2024-04-02

### Bug Fixes

- Fix image export for coreg overlays and spectral shots

## [8.2.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/6.0.0) - 2024-01-29
...
## [8.1.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/5.0.0) - 2023-09-01
...
- **Export Result Lists**: Export a subset of metadata from various result lists within Marsviewer. This includes search results, related imagery subtabs, and co-registered image layers. Click on the download button next to the number of results to open the export modal. Only the currently loaded pages of results will be included in the metadata export. Export options include OCS URLs, filenames, Marsviewer URLs, PNG/JPG image URLs, and a JSON file with a subset of OCS metadata included. Note that for the full set of metadata you should refer to the actual product in Marsviewer/OCS.
- **Add Image Layers from URL or Path**: Add image overlays from Marsviewer URLs, S3 paths, and filenames. To do so, click on the three dot menu to the right of the active overlays header within the Layers tab and select "Add Layers From URL or Path". Multiple layers can be added at once by separating each layer with a comma.
...
- **Role Based Search Filter Presets**: Select role-based search filter presets from the search filter customization menu.
  These presets can be further customized for your instance of Marsviewer.
- **Left Side Tabs Redesign**: Reorganization of the search tabs on the left side of Marsviewer to make room for new search functionalities.
...
## [7.7.0-patch-1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.6.5) - 2023-06-08
...
## [7.7.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.6.3) - 2023-02-23
...
## [7.6.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.5.1) - 2023-01-30

### Bug Fixes

- Use Event.composedPath() instead of Event.path which is now deprecated in Chrome.

## [7.6.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.5.0) - 2022-10-07
...
- Collapsible sections in Marsviewer such as Image Search facets and the sections within the Image tab now have their collapsed state preserved in local storage to allow users to more effectively preserve their application view customizations
...
## [7.5.5](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.0.5) - 2023-01-30

### Bug Fixes

- Use Event.composedPath() instead of Event.path which is now deprecated in Chrome.

## [7.5.3](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.0.3) - 2022-09-19

### Bug Fixes

- Additional minor updates in support of OSD operations.

## [7.5.2](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.0.2) - 2022-08-09

### Bug Fixes

- Updates OSD and sets subpixel rounding to always for all browsers to get rid of tile gap issue seen in Chrome

## [7.5.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.0.1) - 2022-07-11

### Bug Fixes

- Minor fixes to styling bugs and loading states

## [7.5.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/4.0.0) - 2022-06-03
...
- **Active Image Tabs Overhaul**: Reorganization of the tabs on the right side of Marsviewer to make room for new functionalities and improve organization of various existing functionalities.
- **Image Browsing History**: Quickly load recently viewed images using the Image History feature in the top of the app navbar. Open images directly in the Marsviewer tab or in a new tab. History is limited to 100 images and is stored locally in the specific browser you are using so the history will not transfer across different browsers or machines.
...
## [7.4.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.9.3) - 2022-08-16

### Bug Fixes

- Upgrade OpenSeaDragon to 3.1.0 to solve tile gap issues that arose in newer versions of Chrome. Required bringing OSD into Marsviewer source and performing direct modifications to the OSD source code to adapt the 3.1.0 version for Marsviewer's needs.

## [7.4.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.9.2) - 2022-03-03
...
- Fix issue loading searches opened from Marsviewer in new tabs with array-based facet values ([Github #1074](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/issues/1074))
...
## [7.3.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.8.4) - 2022-03-01

### Bug Fixes

- Fix for loading overlays for Quicklooks and User Uploads
- Fix for 8-bit image rendering to support heli nav imaging
- Add VICAR label sequence ID into search base inclusion set
- Repair metadata loading issue

## [7.3.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.8.1) - 2021-10-22
...
## [7.2.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.7.1) - 2021-07-30

### New Features

- **Draw on Image Quicklooks and User Uploads**: Drawing now enabled for Image Quicklooks and User Uploads.
- **Source Image Display**: View the source images for mosaics and reconstructed images in the "Source Images" panel in the Image tab. Click on a source image to open it in a new Marsviewer tab. If the base image has an IDX product you can find the source image used for a particular pixel in the base image by placing an Image Data Explorer cursor and toggling on the "Filter to Data Cursor" option.
...
- **Improved Image Rotation Support**: Image rotation now compatible with Image Data Explorer cursor, targets, and measurements. Current rotation is displayed in the bottom toolbar and is preserved in the Marsviewer URL. Drawings, spectral shots, and image exports are not currently compatible with image rotation.
- **Display GIF Quicklooks**: View GIF quicklooks in Marsviewer with panning and zooming support.
...
- Open the current image a new Marsviewer tab from the "View In" menu in the Image tab
...
## [7.1.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.6.3) - 2021-04-12

### New Features

- **Display Targets**: View 2D, 3D Point, Az/El, amd Proximity targets in Marsviewer. Targets are limited to the site and drive of the base image and are further constrained by base image bounds. View metadata for each target, open targets in ASTTRO and CAMP, and open the target's source image in a new Marsviewer tab. Your selected target is also sharable via URL.
...
- **Improved Image Export**: Image export now respects the aspect ratio of the source image. You can now export what you see in the image viewer at low, medium, high, and actual resolutions. Very large images and mosaics may be too large for the browser export and a non-blocking warning will appear when Marsviewer believes this is the case. If you do see this warning consider exporting the image at a lower resolution or downloading the image as PNG from Marsviewer or DataDrive. Additionally, all export sizes besides "Actual" will likely resample the image. The "Actual" export size should be identical to the Browse PNG produced by IDS except for the default image stretch applied by the Marsviewer image tiler plus any images stretch you may have performed. You can also now optionally export drawings, measurements, targets, and az/el rulers on top of your base image and image overlays.
...
## [7.0.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.5.8) - 2021-04-23

### Bug Fixes

- Simple text change to heli RTE config alias
- Small bug fixes for newly discovered G7.0.1 issues
  - Fixes for Quicklook product visibility and in support of Quicklook processing

## [7.0.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.5.4) - 2021-02-17

### New Features

- **Cloudwatch telemetry logging**: Marsviewer frontend now logs key performance and usage metrics, warnings, and errors for better diagnostics.
- **View PDFs**: View PDFs directly in Marsviewer as well as the accompanying product metadata.
- **In-App Help System**: Browse introductory information and how-to guides within Marsviewer through the "User Guide" available in the "Help" menu.
...
- **Active RDRs Preserved Across Images**: Marsviewer attempts to preserve active RDR products across image switches. Functionality is on by default but can be disabled from the RDR sub-tab in the Overlays tab.
...
- Improved the "best image in exposure group" determination:
  - Marsviewer now uses a single list of fields to determine which image in an exposure is the "best" representation of the exposure to show in search results.
...
## [6.8.1](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.4.0) - 2021-01-11
...
## [6.8.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.3.1) - 2020-11-17
...
## [6.7.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.2.0) - 2020-10-27
...
## [6.6.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/tag/3.1.0) - 2020-09-11
...
- Co-Registration
  ...
  - Open co-reg images in new Marsviewer tab as main image with the previous base image overlaid as a co-reg image (if possible)
...
## [6.5.0](https://github.jpl.nasa.gov/MIPL/react-webmarsviewer/releases/) - 2020-07-24

### Features

- Users can now create custom powerpoint/illustrator-lite drawing layers on top of images in Marsviewer. Users can view multiple drawing layers at once and edit the layers they own. These drawing layers are viewable by other users and shareable via URL once added to the image.
