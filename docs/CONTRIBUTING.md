...
For patch contributions, see our [Developer Documentation](https://github.jpl.nasa.gov/MIPL/astria/wiki) for more details on how to set up your local environment, to best contribute to our project.
...
- [Issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) - a regularly monitored area to report issues with our software or propose changes
- [Discussion board](https://github.jpl.nasa.gov/MIPL/astria/discussions) - a permanently archived place to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
See our list of issues at: https://github.jpl.nasa.gov/MIPL/astria/issues
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) first
...
Take a look at our [pull requests tracking system](https://github.jpl.nasa.gov/MIPL/astria/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues) before considering any documentation contributions. Here's some guidelines:
...
- Source-controlled documentation
  ...
  - [CONTRIBUTING.md](/docs/CONTRIBUTING.md) - guidance on contributing to the project
  - `*.java` - inline documentation available inside code files
- Hosted documentation
  - [Wiki Main-page](https://github.jpl.nasa.gov/MIPL/astria/wiki)
- Discussion Boards
  - [Discussions](https://github.jpl.nasa.gov/MIPL/astria/discussions)
...
- Answer open questions in our [discussion forum](https://github.jpl.nasa.gov/MIPL/astria/discussions)
- Answer open questions mentioned in our [issue tracking system](https://github.jpl.nasa.gov/MIPL/astria/issues)
